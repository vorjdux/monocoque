...
Frozen copy of docs/performance.md at commit c7d7ead (the Phase 0 baseline).
Do not edit. New baselines are added as new files named by their commit sha;
this is the number every later phase must beat or hold, per charter C5.
