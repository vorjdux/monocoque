...
fn main() {
    info!("=== Monocoque ↔ libzmq Interop Test ===\n");
    ...
    compio::runtime::Runtime::new().unwrap().block_on(async {
        ...
        // Receive reply
        let response = dealer.recv().await.expect("Connection closed");
